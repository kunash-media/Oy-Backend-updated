...
public class FAQEntity {
    ...
    public String getFaq5Title() {
        return faq5Title;
    }

    public void setFaq5Title(String faq5Title) {
        this.faq5Title = faq5Title;
    }

    public String getFaq5Description() {
        return faq5Description;
    }

    public void setFaq5Description(String faq5Description) {
        this.faq5Description = faq5Description;
    }

    public String getFaq6Title() {
        return faq6Title;
    }

    public void setFaq6Title(String faq6Title) {
        this.faq6Title = faq6Title;
    }

    public String getFaq6Description() {
        return faq6Description;
    }

    public void setFaq6Description(String faq6Description) {
        this.faq6Description = faq6Description;
    }
}